...
def compile_static_assets(assets):
    ...
    script_generator_less_bundle = Bundle(
        "script_generator_bp/less/script_generator.less",
        filters="less,cssmin",
        output="dist/css/script_generator.css",
        extra={"rel": "stylesheet/less"},
    )
    ...
    assets.register("script_generator_less_bundle", script_generator_less_bundle)
    ...
    if app.config["FLASK_ENV"] == "development":
        ...
        script_generator_less_bundle.build()
